...
class Compose(object):
    ...
    def __call__(self, imgs, inv=False, flow=False):
        for t in self.transforms:
            imgs = t(imgs, inv, flow)
        return imgs
...
class CenterCrop(object):
    ...
    def __call__(self, imgs, inv, flow):
        """
        Args:
...
class Scale(object):
    ...
    def __call__(self, imgs, inv, flow):
        ...
        if isinstance(self.size, int):
            ...
            return [img.resize(self.size, self.interpolation) for img in imgs]
