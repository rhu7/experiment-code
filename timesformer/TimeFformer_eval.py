...
def main_run(dataset, model_state_dict, dataset_dir, seqLen, pretrained_weight):
    ...
    spatial_transform = {'vid': Compose([Scale(256), CenterCrop(224)]), 'pic': Compose([ToTensor(), normalize])}
...
def __main__():
    ...
    parser.add_argument('--memSize', type=int, default=128, help='ConvLSTM hidden state size')
